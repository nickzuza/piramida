...
<div class="box box-primary">
    <div class="box-body">
        <div class="page-header"> @lang('admin.list_units') </div>
        ...
        <div class="box-body pad table-responsive">
            <div class="add_units"><a href="{!! URL::route('add_units') !!}">
                    <button class="btn btn-primary btn-add"><i class="glyphicon-plus"></i> @lang('admin.add_units')
                    </button>
                </a></div>
            <table class="table table-hover">
                <thead>
                <tr>
                    <th>{!! trans('admin.name_units') !!}</th>
                    <th class="text-right">@lang('admin.actions')</th>
                </tr>
                </thead>
                <tbody> @foreach($units as $item)
                    <tr>
                        <td> {!! $item->$name !!} </td>
                        <td class="text-right"><a href="{!! URL::route('edit_units',$item->id ) !!}">
