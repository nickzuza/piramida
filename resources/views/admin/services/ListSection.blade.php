@extends('admin.layouts') @section('content') <?php $name = "name_" . Lang::getLocale(); ?>
<div class="box box-primary">
    <div class="box-body">
        <div class="page-header"> @lang('admin.list_section') </div>
        ...
        <div class="box-body pad table-responsive">
            <div class="add_section"><a href="{!! URL::route('add_section') !!}">
                    <button class="btn btn-primary btn-add"><i class="glyphicon-plus"></i> @lang('admin.add_section')
                    </button>
                </a></div>
            <table class="table table-hover">
                <thead>
                <tr>
                    <th>{!! trans('admin.name_section') !!}</th>
                ...
                <tbody> @foreach($section as $item)
                    <tr>
                        <td> {!! $item->$name !!} </td>
                        <td class="text-center"><img style="max-width: 150px; max-height: 150px" src="{{asset('images/section').'/'.$item->image}}" alt=""> </td>
                        <td class="text-center"> {!! $item->sort_order!!} </td>
                        <td class="text-right"><a href="{!! URL::route('edit_section',$item->id ) !!}">
