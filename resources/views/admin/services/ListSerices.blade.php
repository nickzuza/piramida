...
<div class="box box-primary">
    <div class="box-body">
        <div class="page-header"> @lang('admin.list_service') </div>
        ...
        <div class="box-body pad table-responsive">
            <div class="add_services"><a href="{!! URL::route('add_services') !!}">
                    <button class="btn btn-primary btn-add"><i class="glyphicon-plus"></i> @lang('admin.add_services')
                    </button>
                </a></div>
            <table class="table table-hover">
                <thead>
                <tr>
                    <th>{!! trans('admin.name_service') !!}</th>
                    <th class="text-center">{!! trans('admin.sort_order') !!}</th>
                    <th class="text-right">@lang('admin.actions')</th>
                    <th class="text-right"></th>
                </tr>
                </thead>
                <tbody> @foreach($services as $item)
                    <tr>
                        <td> {!! $item->$name !!} </td>
                        <td class="text-center"> {!! $item->sort_order!!} </td>
                        <td class="text-right"><a href="{!! URL::route('edit_services',$item->id ) !!}">
