...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="page-body">
            ...
            <div class="new-btn">
                <a href="{!! URL::route('add_socials') !!}">
                    <button class="btn btn-primary add_button"><i class="glyphicon-plus"></i> @lang('admin.add_social')</button>
                </a>
            </div>
            <table class="table table-bordered">
                ...
                @foreach($social as  $item)
                    <tr>
                        <td>
                            <img src="{{asset('images/social')."/".$item->image}}" alt="">
                        </td>
                        <td>
                            {{$item->url}}
                        </td>
                        ...
                        <td class="text-center">{{$item->sort_order}}</td>
                            <td class="text-right">
                                <a href="{!! URL::route('edit_socials',$item->id ) !!}">
                                ...
                                <div data-toggle="modal" onclick="deleteProducts('{{$item->id}}','@lang('admin.social')')" data-target="#delete_{{$item->id}}" class="delete-trash btn btn-danger btn-xs">
