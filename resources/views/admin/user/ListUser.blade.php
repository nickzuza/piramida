    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="page-header">
                ...
                @lang('admin.list_admin')

            </div>

            <div class="add_user">

                <a href="{!! URL::route('add_admin') !!}">

                    <button class="btn btn-primary btn-add"><i class="glyphicon-plus"></i> @lang('admin.add_admin')</button>
                        ...
                        @foreach($user as $item)
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="max-width: 100px">
                                    ...
                                    <a href="{!! URL::route('edit_admin',$item->id ) !!}">
