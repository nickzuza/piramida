        ...
        <div class="box-body">
            ...
            <div class="box-body pad table-responsive">
                ...
                <div class="add_caracteristic">
                    ...
                    <a href="{!! URL::route('add_caracteristic') !!}">

                        <button class="btn btn-primary btn-add"><i class="glyphicon-plus"></i> @lang('admin.add_caracteristic')</button>
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>{!! trans('admin.name_caracteristic') !!}</th>
                        ...
                        @foreach($caracteristic as $item)
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{!! URL::route('edit_caracteristic',$item->id ) !!}">
