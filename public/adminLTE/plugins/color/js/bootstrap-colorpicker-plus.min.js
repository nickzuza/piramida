...
!function (a) {
    ...
    var e = 9, f = 10, g = function (b, c) {
        ...
        var r = a('<div class="input-group input-group-sm"><input type="text" class="form-control"/><span class="input-group-btn"><button class="btn btn-default" type="button" title="Custom Color">C</button></span></div>'), s = a("input", r);
